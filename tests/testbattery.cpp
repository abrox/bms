...
SUITE(BatterySuite)
{
    ...
    {
         Battery::Measurement_t data(12.0,-0.24,80);
         Battery::Measurement_t data2(12.0,-7.2,80);
         ...
         std::cout << "\nKoko:" << sizeof(Context_t) << std::endl << sizeof(Config_t) << std::endl;

    }
    TEST_FIXTURE(BatteryFixture,test_getIRCChargeCurrent)
    {
        Battery::Measurement_t data(12.0,2.0,80);
    ...
    TEST_FIXTURE(BatteryFixture,test_updateTimeInStateAndIdle)
    {
        ...
        Battery::Measurement_t chargeData(12.0,bat._cfg.thresholdCurrent+0.0001,80);
    ...
    {
        Battery::Measurement_t chargeData(12.0,bat._cfg.thresholdCurrent+0.0001,80);
        Battery::Measurement_t dischargeData(12.0,0.0-(bat._cfg.thresholdCurrent+0.0001),80);
        Battery::Measurement_t idleData(12.0,bat._cfg.thresholdCurrent,80);
